...
#ifndef SSToolMacros_h
#define SSToolMacros_h
...
#define SSWebVIewImgAutoFit NSString *js = @"function imgAutoFit() { \
...
#define SSModelIdToIdField +(NSDictionary *)mj_replacedKeyFromPropertyName{return @{@"idField" : @"id"};}
#define SSModelObjectClassInArrayWithDic(dic) +(NSDictionary *)mj_objectClassInArray{return (dic);}
...
#define kSSAppName [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleDisplayName"]
//app版本
...
//文章搜索历史记录
#define kSSArticelVCSearchHistoriesCachePath [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"SSArticelVC.plist"]
//会员搜索历史记录
#define kSSClerkSearchVCSearchHistoriesCachePath [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"SSClerkSearchVC.plist"]
#endif /* SSToolMacros_h */
