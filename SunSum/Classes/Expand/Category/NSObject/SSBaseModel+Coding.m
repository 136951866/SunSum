...
static NSString *const kDataKey = @"SSObjCodingKey";

@implementation SSBaseModel (Coding)
...
+ (id)getObjctForKey:(NSString *)key path:(TCodingPath)path{
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:fileName]) {
        ...
        //解档出数据模型Model
        SSBaseModel *model = [unarchiver decodeObjectForKey:kDataKey];
