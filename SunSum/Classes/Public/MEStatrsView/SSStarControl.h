...
@class SSStarControl;
@protocol SSStarsControlDelegate<NSObject>
@optional
...
/**
 ...
 @param score 分数
 */
- (void)starsControl:(SSStarControl *)starsControl didChangeScore:(CGFloat)score;
@end

@interface SSStarControl : UIControl
...
@property (nonatomic, weak)   id<SSStarsControlDelegate> delegate;
//是否允许小数（1位小数），默认为NO
