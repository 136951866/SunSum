...
#import "SSSearchNearAddressVC.h"
#import "SSLocationCLLModel.h"
#import "ZHPlaceInfoModel.h"
#import "ZHPlaceInfoTableViewCell.h"

#define SSSearchNearAddressVCCellIdntifier @"placeInfoCellIdentifier"

@interface SSSearchNearAddressVC ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource>{
...
@implementation SSSearchNearAddressVC
...
- (void)initSomeThing{
     ...
     [self.showTableView registerNib:[UINib nibWithNibName:@"ZHPlaceInfoTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:SSSearchNearAddressVCCellIdntifier];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ZHPlaceInfoTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:SSSearchNearAddressVCCellIdntifier forIndexPath:indexPath];
