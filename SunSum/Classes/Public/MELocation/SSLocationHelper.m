...
@implementation SSLocationHelper
...
-(void)startLocation{
    if (![CLLocationManager locationServicesEnabled]) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            SSAlertView *aler = [[SSAlertView alloc] initWithTitle:@"提示" message:str];
            kMeWEAKSELF
