...
#define TOOLBAR_BUTTON_WIDTH (kMeFrameScaleX() * 65)
...
@interface SSAddressPickerView ()<UIPickerViewDelegate, UIPickerViewDataSource>
///注释
...
@implementation SSAddressPickerView
...
+ (instancetype)provincePickerViewWithProvinceBlock:(void(^)(NSString *province))provinceBlock {
    return [SSAddressPickerView addressPickerViewWithProvince:nil city:nil area:nil provinceBlock:provinceBlock cityBlock:nil areaBlock:nil showType:CZHAddressPickerViewTypeProvince];
}
...
+ (instancetype)cityPickerViewWithCityBlock:(void(^)(NSString *province, NSString *city))cityBlock {
    return [SSAddressPickerView addressPickerViewWithProvince:nil city:nil area:nil provinceBlock:nil cityBlock:cityBlock areaBlock:nil showType:CZHAddressPickerViewTypeCity];
}
...
+ (instancetype)areaPickerViewWithAreaBlock:(void(^)(NSString *province, NSString *city, NSString *area))areaBlock {
    return [SSAddressPickerView addressPickerViewWithProvince:nil city:nil area:nil provinceBlock:nil cityBlock:nil areaBlock:areaBlock showType:CZHAddressPickerViewTypeArea];
}
...
+ (instancetype)provincePickerViewWithProvince:(NSString *)province provinceBlock:(void(^)(NSString *province))provinceBlock {
    return [SSAddressPickerView addressPickerViewWithProvince:province city:nil area:nil provinceBlock:provinceBlock cityBlock:nil areaBlock:nil showType:CZHAddressPickerViewTypeProvince];
}
...
+ (instancetype)cityPickerViewWithProvince:(NSString *)province city:(NSString *)city cityBlock:(void(^)(NSString *province, NSString *city))cityBlock {
    return [SSAddressPickerView addressPickerViewWithProvince:province city:city area:nil provinceBlock:nil cityBlock:cityBlock areaBlock:nil showType:CZHAddressPickerViewTypeCity];
}
...
+ (instancetype)areaPickerViewWithProvince:(NSString *)province city:(NSString *)city area:(NSString *)area areaBlock:(void(^)(NSString *province, NSString *city, NSString *area))areaBlock {
    return [SSAddressPickerView addressPickerViewWithProvince:province city:city area:area provinceBlock:nil cityBlock:nil areaBlock:areaBlock showType:CZHAddressPickerViewTypeArea];
}
...
+ (instancetype)addressPickerViewWithProvince:(NSString *)province city:(NSString *)city area:(NSString *)area provinceBlock:(void(^)(NSString *province))provinceBlock cityBlock:(void(^)(NSString *province, NSString *city))cityBlock areaBlock:(void(^)(NSString *province, NSString *city, NSString *area))areaBlock  showType:(CZHAddressPickerViewType)showType{
    ...
    SSAddressPickerView *_view = [[SSAddressPickerView alloc] init];
...
- (void)czh_setView {
    ...
    containView.frame = CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, kMeFrameScaleY()*270);
    [self addSubview:containView];
    self.containView = containView;
    
    
    UIView *toolBar = [[UIView alloc] init];
    toolBar.frame = CGRectMake(0, 0, SCREEN_WIDTH, kMeFrameScaleY()*55);
    
    toolBar.backgroundColor = CZHColor(0xf6f6f6);
    [containView addSubview:toolBar];
    
    SSBaseButton *cancleButton = [SSBaseButton btnWithFrame:CGRectMake(0, 0, TOOLBAR_BUTTON_WIDTH, toolBar.height) Img:nil title:@"取消" target:self Action:@selector(buttonClick:)];
    [cancleButton setTitleColor:CZHColor(0x666666) forState:UIControlStateNormal];
    cancleButton.titleLabel.font = kMeFont(18);
    cancleButton.tag = CZHAddressPickerViewButtonTypeCancle;
    [toolBar addSubview:cancleButton];
    
    SSBaseButton *sureButton = [SSBaseButton btnWithFrame:CGRectMake(toolBar.width - TOOLBAR_BUTTON_WIDTH, 0, TOOLBAR_BUTTON_WIDTH, toolBar.height) Img:nil title:@"确定" target:self Action:@selector(buttonClick:)];
    [sureButton setTitleColor:kSSPink forState:UIControlStateNormal];
    sureButton.titleLabel.font = kMeFont(18);
