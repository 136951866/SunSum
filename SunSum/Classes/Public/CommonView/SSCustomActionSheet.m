...
-(void)btnCancelAction:(UIButton *)sender{
    [SSModelView closeModelViewWithContentView:self];
}
...
-(void)show{
    ...
    [SSModelView showInView:kMeCurrentWindow contentVIew:self editBgViewHandle:^(SSModelBackGroudView *viewBg) {
