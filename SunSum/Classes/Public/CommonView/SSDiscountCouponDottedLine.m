...
#import "SSDiscountCouponDottedLine.h"

@implementation SSDiscountCouponDottedLine
...
-(void)drawDottedLine{
    ...
    //设置虚线颜色为blackColor
    [dotteShapeLayer setStrokeColor:kSSHexColor(@"e3e3e3").CGColor];
    //设置虚线宽度
