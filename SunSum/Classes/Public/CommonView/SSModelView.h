...
@class SSModelBackGroudView;

@interface SSModelView : NSObject
...
+(void)showInView:(UIView *)superView contentVIew:(UIView *)aView editBgViewHandle:(void (^)(SSModelBackGroudView *viewBg))editHandle;
...
@interface SSModelBackGroudView : UIView
