...
- (void)initSomeThing{
    ...
    [cancelButton setTitleColor:kSSblack forState:UIControlStateNormal];
    ...
    [DoneButton setTitleColor:kSSblack forState:UIControlStateNormal];
