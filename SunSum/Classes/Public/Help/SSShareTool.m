...
/*
 ...
 NSLog(@"分享成功%@",data);
 kMeSTRONGSELF
 [SSShowViewTool showMessage:@"分享成功" view:strongSelf.view];
...
//        [SSPublicNetWorkTool postSharePosterWithId:kMeUnNilStr(self.posterId) SuccessBlock:^(ZLRequestResponse *responseObject) {
//            
//        } failure:^(id object) {
//            
//        }];
//    }
    if(kMeUnNilStr(self.articelId).length){
        [SSPublicNetWorkTool postShareArticelWithId:kMeUnNilStr(self.articelId) SuccessBlock:^(ZLRequestResponse *responseObject) {
