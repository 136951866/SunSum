...
@interface SSShoppingCartGoodsVC ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) UITableView *tableView;

@end

@implementation SSShoppingCartGoodsVC

- (void)viewDidLoad {
    [super viewDidLoad];
//    SSStoreModel *model = [SSStoreModel new];
...
//    SSShoppingCartCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SSShoppingCartCell"];
//    //SSStoreModel *storeModel = self.arrStore[indexPath.section];
//    SSGoodsModel *goodsModel = self.arrStore[indexPath.row];
...
//                         goodsModel:(SSGoodsModel *)goodsModel
...
//    NSInteger count = 0;
//    //先遍历购物车商品, 得到购物车有多少商品
//    for (SSStoreModel *storeModel in self.arrStore) {
