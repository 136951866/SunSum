...
#define kCurrentUser [SSUserInfoModel shareUser]
static NSString *kTokenKey = @"kTokenKey";

@interface SSUserInfoModelTLSData :SSBaseModel
...
@interface SSUserInfoModel : SSBaseModel
...
@property (nonatomic, assign) SSClientTypeStyle client_type;
...
@property (nonatomic, copy) SSUserPathModel *path;

@property (nonatomic, strong) SSUserInfoModelTLSData *tls_data;
