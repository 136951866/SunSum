...
@interface SSPosterActiveVC ()<UITableViewDelegate,UITableViewDataSource>{
    SSActivePosterModel *_model;
}
...
@implementation SSPosterActiveVC

- (void)dealloc{
    kNSNotificationCenterDealloc
}

- (instancetype)initWithModel:(SSActivePosterModel *)model{
    if(self = [super init]){
        _model = model;
    }
    return self;
...
- (void)appointAction:(UIButton *)btn{
    SSCreatePosterVC *vc = [[SSCreatePosterVC alloc]initWithActiveModel:_model];
