...
@protocol SSSNewHomePageViewDelegate <NSObject> // 代理传值方法
- (void)toNoticeVC;
- (void)toVisterVC;
- (void)toProdectVC;
- (void)toServiceVC;
...
@interface SSSNewHomePageView : UIView
...
@property (nonatomic, weak) id<SSSNewHomePageViewDelegate> deleate;
