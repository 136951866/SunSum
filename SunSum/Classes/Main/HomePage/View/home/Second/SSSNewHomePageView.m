...
@interface SSSNewHomePageView ()<SDCycleScrollViewDelegate,LMJScrollTextView2Delegate>{
//    id _model;
}
...
@implementation SSSNewHomePageView
...
- (void)setSdViewWithArr:(NSArray *)array{
    if(kMeUnArr(array)){
        ...
        for (SSSActivityContentModel *model in array) {
