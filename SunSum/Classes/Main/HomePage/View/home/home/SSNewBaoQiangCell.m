...
@implementation SSNewBaoQiangCell
...
- (void)setUIWithArr:(NSArray *)arrModel{
    ...
    for (int i=0; i<arrModel.count; i++) {
        ...
        [img sd_setImageWithURL:[NSURL URLWithString:SSLoadQiniuImagesWithUrl(kMeUnNilStr(obj.images_hot))] placeholderImage:kImgPlaceholder];
    }
}
