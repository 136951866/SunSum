...
const static NSInteger kSSHomeProductCellLimit  = 6;
const static NSInteger kSSHomeServiceCellLimit  = 3;
...
+ (CGFloat)getServiceCellHeightWithArrModel:(NSArray *)arrModel{
    CGFloat cellHeight = kCellOrgialHeight;
    NSUInteger count = arrModel.count>=kSSHomeServiceCellLimit?kSSHomeServiceCellLimit:arrModel.count;
    if(count == 0){
        cellHeight = kCellOrgialHeight - (kViewHeight*2);
