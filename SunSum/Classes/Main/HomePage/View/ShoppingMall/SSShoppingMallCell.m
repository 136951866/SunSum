...
@implementation SSShoppingMallCell
...
- (void)setUIWithModel:(SSGoodModel *)model{
    ...
    [_imgProduct sd_setImageWithURL:[NSURL URLWithString:SSLoadQiniuImagesWithUrl(kMeUnNilStr(model.images))] placeholderImage:kImgPlaceholder];
