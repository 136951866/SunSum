//
//  SSMakeOrderSelectAddressView.m
//  SunSum
//
...
@interface SSMakeOrderSelectAddressView ()
...
@implementation SSMakeOrderSelectAddressView
...
+ (CGFloat)getViewHeightWithModel:(SSAddressModel *)model{
    CGFloat height = kSSMakeOrderSelectAddressViewHeight-15;
    NSString *address = [NSString stringWithFormat:@"%@%@%@%@",kMeUnNilStr(model.province),kMeUnNilStr(model.city),kMeUnNilStr(model.district),kMeUnNilStr(model.detail_address)];
