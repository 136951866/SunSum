...
@interface SSGoodDetailCommentModel : SSBaseModel
...
@interface SSGoodDetailSpecModel : SSBaseModel
...
@interface SSGoodDetailModel : SSBaseModel
...
//选中的price和stock
@property (nonatomic, strong) SSPriceAndStockModel * psmodel;
//当前选中 【@（1），@（0）】
