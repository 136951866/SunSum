...
@interface CouponContentInfo : SSBaseModel
...
@interface ImageContentInfo : SSBaseModel

@property (nonatomic, strong) NSString *url;

@end

@interface CouponInfo : SSBaseModel
@property (nonatomic, strong) NSArray *couponList;
@end

@interface ImageInfo : SSBaseModel

@property (nonatomic, strong) NSArray *imageList;

@end

@interface PriceInfo : SSBaseModel

@property (nonatomic, strong) NSString * price;

@end

@interface CommissionInfo : SSBaseModel

@property (nonatomic, assign) CGFloat commission;

@end

@interface SSJDCoupleModel : SSBaseModel
