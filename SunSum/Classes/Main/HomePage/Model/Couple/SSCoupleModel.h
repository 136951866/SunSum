...
@interface SSCoupleSmallImageModel : SSBaseModel

@property (nonatomic, copy) NSArray *string;

@end

@interface SSCoupleModel : SSBaseModel
...
@property (nonatomic, strong) SSCoupleSmallImageModel * small_images;
@property (nonatomic, strong) NSString * title;
...
- (void)resetModelWithModel:(SSCouponInfo *)model;
@end
