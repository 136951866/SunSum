...
@interface SSCoupleDetailImageModle : SSBaseModel

@property (nonatomic, copy) NSArray *string;

@end

@interface SSCoupleDetailModle : SSBaseModel
...
@property (nonatomic, strong) SSCoupleDetailImageModle * small_images;
