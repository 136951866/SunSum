...
@interface SSAppointOrderMainCell (){
    SSServiceDetailsModel *_model;
}
...
- (void)setUIWithModel:(SSServiceDetailsModel *)model attrModel:(SSAppointAttrModel *)attrModel{
    ...
    kSDLoadImg(_imgPic, SSLoadQiniuImagesWithUrl(kMeUnNilStr(model.serviceDetail.images)));
