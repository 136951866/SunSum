...
@interface SSStoreHomeIntroduceCell (){
...
@implementation SSStoreHomeIntroduceCell
...
+ (CGFloat)getCellHeightWithModel:(SSStoreDetailModel *)model isExpand:(BOOL)isExpand{
    if(isExpand){
        CGFloat height = kSSStoreHomeIntroduceCellHeight -17;
        ...
        return kSSStoreHomeIntroduceCellHeight;
    }
}
