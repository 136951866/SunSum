...
@interface SSBrandAreasplineCell ()<AAChartViewDidFinishLoadDelegate>
...
@implementation SSBrandAreasplineCell
...
- (void)setUiWithModel:(NSArray *)model title:(NSString *)title subTitle:(NSString *)subTitle{
    ...
    [temp enumerateObjectsUsingBlock:^(SSBrandTotalModel *obj, NSUInteger idx, BOOL * _Nonnull stop) {
