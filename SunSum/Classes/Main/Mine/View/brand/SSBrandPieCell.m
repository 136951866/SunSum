...
@interface SSBrandPieCell ()<AAChartViewDidFinishLoadDelegate>
...
- (void)setUiWithModel:(NSArray *)model{
    ...
    [model enumerateObjectsUsingBlock:^(SSBrandPercentModel *obj, NSUInteger idx, BOOL * _Nonnull stop) {
