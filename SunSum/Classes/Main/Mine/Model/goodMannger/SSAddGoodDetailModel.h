...
@interface SSAddGoodDetailGroupModel : SSBaseModel
...
@interface SSAddGoodDetailSpecIdsValueModel : SSBaseModel
...
@interface SSAddGoodDetailSpecIdsModel : SSBaseModel
...
@interface SSAddGoodDetailSpecNameModel : SSBaseModel
...
@interface SSAddGoodDetailModel : SSBaseModel
