...
@interface SSCompandNoticeVC ()<UITableViewDelegate,UITableViewDataSource>{
    NSString *_equities;
}
...
@implementation SSCompandNoticeVC
...
- (void)networkRequest{
    kMeWEAKSELF
    [SSPublicNetWorkTool getUserGetEquitiesWithSuccessBlock:^(ZLRequestResponse *responseObject) {
        kMeSTRONGSELF
